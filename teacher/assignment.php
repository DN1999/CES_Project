...
<html lang="en">
  ...
  <body>
   ...
   <!-- NavBar End -->
      <div class="container">
        <h1 class="text-center"> <?php if(isset($_SESSION['subjectName'])){?><?php echo $_SESSION['subjectName']; }?> Assignment Marks Evaluation </h1>
            ...
            <tbody>
              ...
              while($array = mysqli_fetch_array($data,MYSQLI_ASSOC)){
                ...
                <tr>
                    ...
                    <td><input type="number" value="<?php echo $array['assign1'];?>" style="width:60px;"  name="assign1"/></td>
                    <td><input type="number" value="<?php echo $array['assign2'];?>" style="width:60px;" name="assign2"/></td>
                    <td><input type="number" value="<?php echo $array['assign3'];?>" style="width:60px;" name="assign3"></td>
                    <td><input type="number" value="<?php echo $array['assign4'];?>" style="width:60px;" name="assign4"></td>
                    <td><input type="number" value="<?php echo $array['assign5'];?>" style="width:60px;" name="assign5"></td>
                    <td><input type="hidden" value="<?php echo $array['assigntotal'];?>" name="totalAssign" id="total"><?php echo $array['assigntotal'];?> </td>
               
                    <td><input type="hidden" value="<?php echo $array['assignConvertM'];?>" name="convertTotal" id="total"><?php echo $array['assignConvertM'];?></td>
                    <td><button class="btn btn-success" name="UpdateAssign">Update</button></td>
