...
<html lang="en">
  ...
  <body>
   ...
   <!-- NavBar End -->
   <div class="container">
   <h1 class="text-center"> <?php if(isset($_SESSION['subjectName'])){?><?php echo $_SESSION['subjectName']; }?> Practical Viva Marks Evaluation </h1>
            ...
            <thead>
              <tr>
               ...
               <th scope="col">Sr.No</th>
                ...
                <th scope="col">Practical Viva<br>(50M)</th>
                <th scope="col"> *** </th>
              </tr>
            </thead>
            <tbody>
              ...
              while($array = mysqli_fetch_array($data,MYSQLI_ASSOC)){
                ...
                <tr>
                    ...
                    <td><input type="number" value="<?php echo $array['practicalViva'];?>" style="width:60px;"  name="practicalViva"/></td>

                    <td><button class="btn btn-success" name="UpdatePracticalViva">Update</button></td>
