...
<body>
    ...
    <form action="loginPagedb.php" method="post">
            ...
            <div class="card-body p-5">
                ...
                <h3 class="mb-5 pt-5 text-center">Admin Login</h3>
                 <?php if(isset($_SESSION['MessageAdmin'])){?>
                    <p class="text-center text-danger"><?php echo $_SESSION['MessageAdmin']; ?></p>
                    <?php unset($_SESSION['MessageAdmin']); }?>
                        ...
                        <div class="form-group mx-5 mt-3">
                            ...
                            <input type="password" id="password" name="password" class="form-control" style="width:20rem;" placeholder="123456"/>
                        </div>
